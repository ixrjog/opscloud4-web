<template>
  <el-tag size="mini" style="float: right;margin-right: 5px" class="position" :type="pod | toPodPhaseType">
    ...
    <el-popover placement="right" trigger="hover">
      ...
      <br/>
      <entry-detail name="Ready" :value="pod.conditions.Ready"></entry-detail>
      <br/>
      <entry-detail name="ContainersReady" :value="pod.conditions.ContainersReady"></entry-detail>
      <br/>
      <entry-detail name="PodScheduled" :value="pod.conditions.PodScheduled"></entry-detail>
    </el-popover>
  </el-tag>
</template>

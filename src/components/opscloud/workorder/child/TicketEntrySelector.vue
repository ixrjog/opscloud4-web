  ...
  <div>
    <el-row :gutter="24">
      <el-select v-model="ticketEntry" filterable clearable value-key="name"
                 ...
                 remote reserve-keyword :placeholder="'输入关键词搜索'+ entryDesc" :remote-method="fetchData" @change="fetchData"
...
import { QUERY_WORK_ORDER_TICKET_ENTRY } from '@/api/modules/workorder/workorder.ticket.api'

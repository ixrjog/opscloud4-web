          ...
          <el-card shadow="hover">
            ...
            <ticket-entry-table :ticketId="ticketView.ticketId"
              ...
              <template v-slot:extend>
                <el-table-column label="Istio Switch" width="300px">
                  <template v-slot="scope">
                    <el-tag v-if="scope.row.entry.istioInject === 'false'" type="success" size="mini">Enable Istio</el-tag>
                    <el-tag v-if="scope.row.entry.istioInject === 'true'" type="danger" size="mini">Disable Istio</el-tag>
                  </template>
                </el-table-column>
              </template>
            </ticket-entry-table>
...
import SelectPromptColorTag from '@/components/opscloud/common/tag/SelectPromptColorTag.vue'
...
export default {
  ...
  name: 'KubernetesIstioConfigurationTicketEditor',
  props: ['formStatus'],
  components: {

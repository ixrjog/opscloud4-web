<template>
  <d2-container>
    ...
    <gitlab-project-ticket-editor :formStatus="formStatus.ticket.gitlab.project" ref="gitlabProjectTicketEditor" @close="fetchData"></gitlab-project-ticket-editor>
    <gitlab-group-ticket-editor :formStatus="formStatus.ticket.gitlab.group" ref="gitlabGroupTicketEditor" @close="fetchData"></gitlab-group-ticket-editor>
    <ons-topic-ticket-editor :formStatus="formStatus.ticket.ons.topic" ref="onsTopicTicketEditor" @close="fetchData"></ons-topic-ticket-editor>
    <ons-group-ticket-editor :formStatus="formStatus.ticket.ons.group" ref="onsGroupTicketEditor" @close="fetchData"></ons-group-ticket-editor>
    ...
    <sns-topic-ticket-editor :formStatus="formStatus.ticket.sns.topic" ref="snsTopicTicketEditor" @close="fetchData"></sns-topic-ticket-editor>
    <sns-subscription-ticket-editor :formStatus="formStatus.ticket.sns.subscription" ref="snsSubscriptionTicketEditor" @close="fetchData"></sns-subscription-ticket-editor>
    <application-scale-replicas-ticket-editor :formStatus="formStatus.ticket.applicationScaleReplicas" ref="applicationScaleReplicasTicketEditor" @close="fetchData"></application-scale-replicas-ticket-editor>
    <apollo-ticket-editor :formStatus="formStatus.ticket.apollo" ref="apolloTicketEditor" @close="fetchData"></apollo-ticket-editor>
  </d2-container>
</template>

<template>
  <div>
    <el-button type="primary" v-if="false" @click="dialogVisible = true" plain round>
      <d2-icon name="fas fa-question-circle" class="d2-mr-5"/>
      需要帮助吗
    </el-button>
    <el-dialog
      title="帮助"
